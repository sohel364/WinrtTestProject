...
using namespace WinrtTestProject;
using namespace WinrtTestProject::implementation;
    ...
    if (rootFrame == nullptr)
    {
        ...
        if (e.PrelaunchActivated() == false)
        {
            if (rootFrame.Content() == nullptr)
            {
                ...
                // parameter
                rootFrame.Navigate(xaml_typename<WinrtTestProject::MainPage>(), box_value(e.Arguments()));
            }
